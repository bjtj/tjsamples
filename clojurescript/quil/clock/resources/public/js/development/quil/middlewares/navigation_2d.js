...
return cljs.core.merge.call(null,initial_state,p1__22324_SHARP_);
});})(initial_state))
);
});
/**
...
var nav_2d_22325 = new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611).cljs$core$IFn$_invoke$arity$1(state);
var zoom_22326 = new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(nav_2d_22325);
var pos_22327 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(nav_2d_22325);
quil.core.scale.call(null,zoom_22326);

var tr__22221__auto___22328 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width.call(null) / (2)) / zoom_22326) - cljs.core.first.call(null,pos_22327)),(((quil.core.height.call(null) / (2)) / zoom_22326) - cljs.core.second.call(null,pos_22327))], null);
quil.core.push_matrix.call(null);

try{quil.core.translate.call(null,tr__22221__auto___22328);
...
//# sourceMappingURL=navigation_2d.js.map?rel=1632532618098

...
class TodoList extends Component {
    ...
    addListItem() {
	this.props.navigation.getParam('store').addListItem(this.state.text);
	this.setState({
	    text: '',
    ...
    removeListItem(item) {
	this.props.navigation.getParam('store').removeListItem(item);
    }
	...
	const { list } = this.props.navigation.getParam('store');
	return (

...
//------------------------------------------------------------------------------------------------
//모든 배열을 채워야 합니다(예: GetCopyableFootprints를 호출하여)
...
//------------------------------------------------------------------------------------------------
// UpdateSubresources 구현을 스택 할당 중
...
{
    // 이 캐스트는 강력한 형식의 명령 목록 포인터를 전달하는 데 유용합니다.
    // ExecuteCommandLists.
    // 이 캐스트는 const-ness를 준수하는 한 유효합니다. D3D12 API가 수행합니다.
    // 해당 인수의 const-ness를 준수합니다.
